...
class LadyLee(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        for local_category in url_extensions:
            ...
            while True:
                ...
                url_webpage = (
                    "https://api.c8gqzlqont-mantenimi1-p1-public.m"
    ...
    def products_for_url(cls, url, category=None, extra_args=None):
        ...
        sku = url.split("/")[4]
        product_url = (
            "https://api.c8gqzlqont-mantenimi1-p1-public.model-t.c"
        ...
        name = json_data["name"]
        price = Decimal(remove_words(json_data["price"]["formattedValue"], ["L.", ","]))
