...
class Siman(Store):
    ...
    def discover_urls_for_category(cls, category, extra_args=None):
        ...
        while True:
            ...
            endpoint = (
                "https://{}.siman.com/_v/segment/graphql/v1"
                "?extensions={}".format(cls.country_url, json.dumps(payload))
            )
    ...
    def products_for_url(cls, url, category=None, extra_args=None):
        ...
        product_state_tag = soup.find("template", {"data-varname": "__STATE__"})
    ...
    def preflight(cls, extra_args=None):
        return vtex_preflight(
            extra_args,
            "https://{}.siman.com/tecnologia/pantallas".format(cls.country_url),
        )
